...
const KNOWN_SNIPPETS = {
  ...
  // Hadith only — never map to Hudhaify: «إن الله طيب لا يقبل إلا طيبا»، «إن الله هو الحكم وإليه الحكم».
...
const MANUAL = {
  ...
  // Hadith citation (إن الله طيب…) — not Quran; do not force Hudhaify.
  ...
  '119d35bc-1357-43b6-a136-0700351ecf99': '76:7',
  ...
  // Bare / quoted ayah in live bank (no orphans).
  '94c4e444-476e-50ec-1160-472655b5cfed': '53:19',
  '7553099d-8f57-26fe-d67f-1169936f4a29': '53:19',
  '4bd70525-216d-9c50-492c-ad0e11e6123c': '64:11',
  '8763fe64-4a49-cdc3-d58f-3f7d8649a5e8': '27:62',
  'b72ea408-d6ee-dfa4-851c-8d2752266c93': '9:31',
  '32063d02-b9d8-1c56-c796-ce94db8df17b': '108:2',
  '75617456-3451-c015-841e-f6a54d558d06': '12:106',
  '6c71a8c8-dc70-2a62-ef90-94e21c535a51': '96:1',
  'bb712df7-5aa7-7e07-7cd8-89a90d6efb19': '74:1',
  'f28d7b89-dd4a-7a37-b0c5-5ab506ab69b3': '7:138',
  'd12b38d3-b220-725b-20ce-02ae7cae64d9': '7:138',
};
