...
export function prepareFishTtsText(text) {
  ...
  s = s.replace(/^أَنْوَاطْ$/u, 'ذَاتُ أَنْوَاطْ');
  s = s.replace(/^أنواط$/u, 'ذَاتُ أَنْوَاطْ');
  ...
  s = s.replace(/^الطِّبّ?[َُِْ]?$/u, 'هُوَ الطِّبُّ');
  s = s.replace(/^الطِّبّ?[َُِْ]?$/u, 'هُوَ الطِّبُّ');
  s = s.replace(/^الطب$/u, 'هُوَ الطِّبُّ');
  ...
  // Residual short nouns still mangled after هُوَ/هِيَ pad — fuller carriers
  s = s.replace(/^هُوَ\s+الطِّبُّ$/u, 'الطِّبُّ النَّبَوِيُّ');
  s = s.replace(/^هُوَ\s+الطِّبُّ$/u, 'الطِّبُّ النَّبَوِيُّ');
  s = s.replace(/^عِلْمُ\s+الطِّبِّ$/u, 'الطِّبُّ النَّبَوِيُّ');
