...
export function prepareFishTtsText(text) {
  ...
  s = s.replace(/(^|[^\u0621-\u064A])ابن\s+مسعود(?=[^\u0621-\u064A]|$)/g, '$1عَبْدُ اللَّهِ بْنُ مَسْعُودٍ');
  ...
  // ابن مسعود → الاسم الكامل؛ مجرور بعد حديث
  s = s.replace(/حَدِيث[ٍِ]?\s+(?:عَبْد[ُِ]\s+اللَّهِ\s+)?(?:ابْن|بْن)[ُِْ]?\s*مَسْعُودٍ/g, 'حَدِيثِ  عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ');
  s = s.replace(/عَبْدُ\s+اللَّهِ\s+بْنُ\s+مَسْعُودٍ/g, 'عَبْدُ  اللَّهِ  بْنُ  مَسْعُودٍ');
  s = s.replace(/عَبْدِ\s+اللَّهِ\s+بْنِ\s+مَسْعُودٍ/g, 'عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ');
  s = s.replace(/ابْن[ُِْ]?\s*مَسْعُودٍ/g, 'عَبْدُ  اللَّهِ  بْنُ  مَسْعُودٍ');
  ...
  s = s.replace(
    /قَرَّبَ\s+حَشَرَةَ\s+الذُّبَابِ\s+ذُبَابَةً\s+وَاحِدَةً\s+لِلصَّنَمِ/g,
    DHUBAB_QARRABA
  );
  s = s.replace(
    /قَرَّبَ\s+حَشَرَةً\s+تُسَمَّى\s+الذُّبَابَةَ\s+لِلصَّنَمِ/g,
    DHUBAB_QARRABA
  );
  s = s.replace(
    /قَرَّبَ\s+حَشَرَةً\s+تُسَمَّى\s+الذُّبَابَةَ\s+لِلصَّنَمِ/g,
    DHUBAB_QARRABA
  );
  s = s.replace(
    /قَرَّبَ\s+ذُبَابًا\s+لِلصَّنَمِ/g,
    DHUBAB_QARRABA
  );
  s = s.replace(
  ...
  // أهل اليمن — إِقْلِيمِ أوضح في الجمل الطويلة من بِلَادِ/بَلَدِ (تجنّب بلادي/اليماني)
  s = s.replace(/أَهْل[َِ]?\s+بِلَادِ\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/أَهْل[َِ]?\s+بَلَدِ\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/أَهْل[َِ]?\s+إِقْلِيمِ\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/أَهْل[َِ]?\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/اهل\s+اليمن/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/أهل\s+اليمن/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  // ابن مسعود — الاسم الكامل + بْنُ (يقلّل ابني/مشعود)
  s = s.replace(/^ابْن[ُِْ]?\s*مَسْعُودٍ$/u, 'هُوَ عَبْدُ اللَّهِ بْنُ مَسْعُودٍ');
  s = s.replace(/^ابن\s+مسعود$/u, 'هُوَ عَبْدُ اللَّهِ بْنُ مَسْعُودٍ');
  s = s.replace(/حَدِيث[ٍِ]?\s+(?:عَبْد[ُِ]\s+اللَّهِ\s+)?ابْن[ُِْ]?\s*مَسْعُودٍ/g, 'حَدِيثِ  عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ');
  s = s.replace(/حَدِيث[ٍِ]?\s+ابْن[ُِْ]?\s*مَسْعُودٍ/g, 'حَدِيثِ  عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ');
  s = s.replace(/في\s+حديث\s+ابن\s+مسعود/g, 'فِي حَدِيثِ عَبْدِ اللَّهِ بْنِ مَسْعُودٍ');
  s = s.replace(/قال\s+ابن\s+مسعود/g, 'قَالَ عَبْدُ اللَّهِ بْنُ مَسْعُودٍ');
  s = s.replace(/ابن\s+مسعود/g, 'عَبْدُ اللَّهِ بْنُ مَسْعُودٍ');
  s = s.replace(/(?<!عَبْد[ُِ]\s{0,2}اللَّهِ\s{0,2})ابْن[ُِْ]?\s+مَسْعُودٍ/g, 'عَبْدُ اللَّهِ بْنُ مَسْعُودٍ');
  s = s.replace(/عَبْدُ\s+اللَّهِ\s+بْنُ\s+مَسْعُودٍ/g, 'عَبْدُ  اللَّهِ  بْنُ  مَسْعُودٍ');
  s = s.replace(/عَبْدِ\s+اللَّهِ\s+بْنِ\s+مَسْعُودٍ/g, 'عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ');
  ...
  // أهل اليمن — short stays بَلَدِ via carrier؛ inline → إِقْلِيمِ
  s = s.replace(/أَهْلَ\s+إِقْلِيمِ\s+إِقْلِيمِ\s+الْيَمَنِ/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/أَهْلَ\s+بَلَدِ\s+بَلَدِ\s+الْيَمَنِ/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/أَهْلَ\s+بِلَادِ\s+بِلَادِ\s+الْيَمَنِ/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  s = s.replace(/أَهْلَ\s+الْيَمَنِ/g, 'أَهْلَ  إِقْلِيمِ  الْيَمَنِ');
  // whole-utterance short: keep بَلَدِ (أوضح للمستمع القصير)
  s = s.replace(/^أَهْلَ\s+إِقْلِيمِ\s+الْيَمَنِ$/u, 'أَعْنِي أَهْلَ بَلَدِ الْيَمَنِ');
  s = s.replace(/^أَهْلَ\s+بَلَدِ\s+الْيَمَنِ$/u, 'أَعْنِي أَهْلَ بَلَدِ الْيَمَنِ');
  s = s.replace(/^أَهْلَ\s+بِلَادِ\s+الْيَمَنِ$/u, 'أَعْنِي أَهْلَ بَلَدِ الْيَمَنِ');
  s = s.replace(/^أَعْنِي\s+أَهْلَ\s+بِلَادِ\s+الْيَمَنِ$/u, 'أَعْنِي أَهْلَ بَلَدِ الْيَمَنِ');
  s = s.replace(/^أَعْنِي\s+أَهْلَ\s+بَلَدِ\s+الْيَمَنِ$/u, 'أَعْنِي أَهْلَ بَلَدِ الْيَمَنِ');
  s = s.replace(/^أَعْنِي\s+أَهْلَ\s+إِقْلِيمِ\s+الْيَمَنِ$/u, 'أَعْنِي أَهْلَ بَلَدِ الْيَمَنِ');
  // لا ضرر ولا ضرار — نصب بلا + فجوات (الحامل الكامل للجملة القصيرة عبر carriers)
  ...
  // إن وُجد تكرار حامل من نسخة سابقة
  s = s.replace(/أَعْنِي\s+قَاعِدَةَ\s+أَعْنِي\s+قَاعِدَةَ/g, 'أَعْنِي قَاعِدَةَ');
  s = s.replace(/قَاعِدَةُ\s+أَعْنِي\s+قَاعِدَةَ/g, 'قَاعِدَةُ');
  s = s.replace(/الْحَدِيثَ\s+أَعْنِي\s+قَاعِدَةَ/g, 'الْحَدِيثَ');
  ...
  s = applyShortSpeechCarriers(s);
  // عبد الله بن مسعود — إعراب الاسم بعد الحاملات/النهايات النظامية
  s = s.replace(
    /فِي\s+حَدِيث[ٍِ]?\s+عَبْد[ُِ]\s+اللَّهِ\s+بْن[ُِ]\s+مَسْعُودٍ/g,
    'فِي حَدِيثِ  عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ'
  );
  s = s.replace(
    /في\s+حديث\s+عَبْد[ُِ]\s+اللَّهِ\s+بْن[ُِ]\s+مَسْعُودٍ/g,
    'فِي حَدِيثِ  عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ'
  );
  s = s.replace(
    /حَدِيث[ٍِ]?\s+عَبْد[ُِ]\s+اللَّهِ\s+بْن[ُِ]\s+مَسْعُودٍ/g,
    'حَدِيثِ  عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ'
  );
  s = s.replace(
    /حديث\s+عَبْد[ُِ]\s+اللَّهِ\s+بْن[ُِ]\s+مَسْعُودٍ/g,
    'حَدِيثِ  عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ'
  );
  s = s.replace(/هُوَ\s+عَبْدِ\s+اللَّهِ\s+بْنُ/g, 'هُوَ عَبْدُ اللَّهِ بْنُ');
  s = s.replace(/قَالَ\s+عَبْدِ\s+اللَّهِ\s+بْنُ/g, 'قَالَ عَبْدُ اللَّهِ بْنُ');
  s = s.replace(/قال\s+عَبْدِ\s+اللَّهِ\s+بْنُ/g, 'قَالَ عَبْدُ اللَّهِ بْنُ');
  s = s.replace(/عَبْدُ\s+اللَّهِ\s+بْنُ\s+مَسْعُودٍ/g, 'عَبْدُ  اللَّهِ  بْنُ  مَسْعُودٍ');
  s = s.replace(/عَبْدِ\s+اللَّهِ\s+بْنِ\s+مَسْعُودٍ/g, 'عَبْدِ  اللَّهِ  بْنِ  مَسْعُودٍ');
