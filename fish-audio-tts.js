...
export function prepareFishTtsText(text) {
  ...
  // أهل اليمن — بَلَدِ أوضح من بِلَادِ في الجمل الطويلة (تجنّب بلادي/اليمان)
  s = s.replace(/أَهْل[َِ]?\s+بِلَادِ\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
  s = s.replace(/أَهْل[َِ]?\s+بَلَدِ\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
  s = s.replace(/أَهْل[َِ]?\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
  s = s.replace(/اهل\s+اليمن/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
  s = s.replace(/أهل\s+اليمن/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
  ...
  // أهل اليمن — strengthen STT؛ لا تكرّر بَلَدِ/بِلَادِ
  s = s.replace(/أَهْلَ\s+بَلَدِ\s+بَلَدِ\s+الْيَمَنِ/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
  s = s.replace(/أَهْلَ\s+بِلَادِ\s+بِلَادِ\s+الْيَمَنِ/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
  s = s.replace(/أَهْلَ\s+الْيَمَنِ/g, 'أَهْلَ  بَلَدِ  الْيَمَنِ');
