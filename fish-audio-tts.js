...
export function prepareFishTtsText(text) {
  ...
  // قرب ذبابا لصنم — تُسَمَّى الذُّبَابَة (ذ≠د) + للصنم
  s = s.replace(
    /قَرَّبَ\s+حَشَرَةَ\s+الذُّبَابِ\s+ذُبَابَةً\s+وَاحِدَةً\s+لِلصَّنَمِ/g,
    "قَرَّبَ حَشَرَةً تُسَمَّى الذُّبَابَةَ لِلصَّنَمِ"
  );
  s = s.replace(
  ...
  s = s.replace(/قَرَّبَ\s+ذُبَابًا\s+لِصَنَمٍ/g, "قَرَّبَ حَشَرَةً تُسَمَّى الذُّبَابَةَ لِلصَّنَمِ");
  s = s.replace(/قَرَّبَ\s+ذُبَابًا\s+لِصَنَمٍ/g, "قَرَّبَ حَشَرَةً تُسَمَّى الذُّبَابَةَ لِلصَّنَمِ");
  s = s.replace(/قرب\s+ذباباً?\s+لصنم/g, "قَرَّبَ حَشَرَةً تُسَمَّى الذُّبَابَةَ لِلصَّنَمِ");
  s = s.replace(/قَرَّبَ\s+ذُبَابًا\s+وَاحِدًا\s+لِلصَّنَمِ/g, "قَرَّبَ حَشَرَةً تُسَمَّى الذُّبَابَةَ لِلصَّنَمِ");
  s = s.replace(/(^|[^\u0621-\u064A])ذُبَابًا(?=[^\u0621-\u064A]|$)/g, "$1حَشَرَةً تُسَمَّى الذُّبَابَةَ");
  s = s.replace(/(^|[^\u0621-\u064A])فِي\s+ذُبَابٍ/g, "$1فِي  حَشَرَةِ  الذُّبَابِ");
  s = s.replace(/(^|[^\u0621-\u064A])في\s+ذباب/g, "$1فِي  حَشَرَةِ  الذُّبَابِ");
  ...
  // أهل اليمن — بلاد + فجوات (تجنّب اليمين/اليمان)
  s = s.replace(/أَهْل[َِ]?\s+بِلَادِ\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  بِلَادِ  الْيَمَنِ');
  s = s.replace(/أَهْل[َِ]?\s+الْيَمَن[َُِْ]?/g, 'أَهْلَ  بِلَادِ  الْيَمَنِ');
  s = s.replace(/اهل\s+اليمن/g, 'أَهْلَ  بِلَادِ  الْيَمَنِ');
  s = s.replace(/أهل\s+اليمن/g, 'أَهْلَ  بِلَادِ  الْيَمَنِ');
  ...
  // أهل اليمن — strengthen STT (اليمين)؛ لا تكرّر بِلَادِ
  s = s.replace(/أَهْلَ\s+بِلَادِ\s+بِلَادِ\s+الْيَمَنِ/g, 'أَهْلَ  بِلَادِ  الْيَمَنِ');
  ...
  s = s.replace(/^أَعْنِي\s+أَهْلَ\s+بِلَادِ\s+الْيَمَنِ$/u, 'أَعْنِي أَهْلَ بِلَادِ الْيَمَنِ');
