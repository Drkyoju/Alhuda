...
window.AYAH_SNIPPET_MAP = {
  ...
  // Do NOT map bare «اللات والعزى ومناة[ الثالثة]» — those are MC question stems;
  // stripKnownAyahSnippetsForSpeech was eating the names and leaving only «ذكرت في سورة».
