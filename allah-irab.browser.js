...
const _D = '\u064F';
const _K = '\u0650';
const ALLAH_NOM = `الل${_SH}${_F}ه${_D}`; // مرفوع اللَّهُ
const ALLAH_ACC = `الل${_SH}${_F}ه${_F}`; // منصوب اللَّهَ
const ALLAH_GEN = `الل${_SH}${_F}ه${_K}`; // مجرور اللَّهِ
const ALLAHUMMA = `الل${_SH}${_F}ه${_D}م${_SH}${_F}`;
const LILLAH = `لِل${_SH}${_F}ه${_K}`;
const BILLAH = `بِالل${_SH}${_F}ه${_K}`;
const WALLAH = `وَالل${_SH}${_F}ه${_K}`;
const FALLAH = `فَالل${_SH}${_F}ه${_K}`;
const TALLAH = `تَالل${_SH}${_F}ه${_K}`;
const KALLAH = `كَالل${_SH}${_F}ه${_K}`;
const WALILLAH = `وَلِل${_SH}${_F}ه${_K}`;
const FALILLAH = `فَلِل${_SH}${_F}ه${_K}`;
const ILLA_ALLAH = `إِل${_SH}${_F}ا ${ALLAH_ACC}`;
const LA_ILAHA_ILLA_ALLAH = `لَا إِلَٰهَ إِل${_SH}${_F}ا ${ALLAH_NOM}`;
const LA_MABUDA_BIHAQQ_ILLA_ALLAH = `لَا مَعْبُودَ بِحَق${_SH}${_K} إِل${_SH}${_F}ا ${ALLAH_ACC}`;
