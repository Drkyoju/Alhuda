...
const MANUAL_SPEECH_DIACRITICS = [
  ...
  ['لا ضرر ولا ضرار', 'أَعْنِي قَاعِدَةَ لَا  ضَرَرَ  عَلَى أَحَدٍ  وَلَا  ضِرَارَ'],
  ['ابن مسعود', 'عَبْدُ اللَّهِ بْنُ مَسْعُودٍ'],
  ...
  ['دخل الجنة رجل في ذباب ودخل النار رجل في ذباب', 'دَخَلَ الْجَنَّةَ رَجُلٌ فِي الذَّالِ ثُمَّ الذُّبَابِ، وَدَخَلَ النَّارَ رَجُلٌ فِي الذَّالِ ثُمَّ الذُّبَابِ'],
